---
title: 经典排序算法
date: 2019-07-04 09:50:44
photos: ../images/190704/01.jpg
categories:
- 常用算法
tags:
- 排序算法
...
###### 算法总结
<img src="/images/190704/02.png">

##### 算法分类
<img src="/images/190704/03.png">        
...
从不是空的桶里把排好序的数据拼接起来。   
<strong>注意，如果递归使用桶排序为各个桶排序，则当桶数量为1时要手动减小BucketSize增加下一循环桶的数量，否则会陷入死循环，导致内存溢出。<strong>
